...
public class AddBook extends javax.swing.JDialog {
    ...
    public void listPublishers() {
        try{
            ...
            for(Publisher pub : publishers){
                modelPublishers.addElement(pub);
            }
        }catch(Exception ex){
            ex.printStackTrace();
        }
    ...
    public boolean validBook(Book b)throws Exception {
        ...
        //validation ID width regex ex: BU1111,BU0001,AU2220
        String IDregex = "^[A-Z]{2}[0-9]{4}";
        if(Pattern.matches(IDregex,txtBookID.getText())==false){
            JOptionPane.showMessageDialog(AddBook.this,"Book ID not validation.Book ID must be in format.Ex:BU0001,AU2230..","Alert",JOptionPane.ERROR_MESSAGE);
            txtBookID.requestFocus();
            return false;
        }
        ...
        if(modelSelectedAuthor.isEmpty()){
            JOptionPane.showMessageDialog(AddBook.this,"Author cannot be empty","Alert",JOptionPane.ERROR_MESSAGE);
