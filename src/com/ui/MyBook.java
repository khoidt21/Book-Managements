...
public class MyBook extends javax.swing.JFrame {
    ...
    public void searchBooks() {
       try{
           // create a list of column of book table,this one should be matched dropdownlist 
           String[] colums = {"books.title_id","books.title","publishers.pub_name","authors.au_name","books.notes"};
           // collect column name and keyword 
           String columnName = colums[cboColumn.getSelectedIndex()];
