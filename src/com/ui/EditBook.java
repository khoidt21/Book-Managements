...
public class EditBook extends javax.swing.JDialog {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try{
              if(JOptionPane.showConfirmDialog(EditBook.this, "Do you want delete this book ?","Confirmation",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                  myBook.bookController.deleteBook(txtBookID.getText());
                  JOptionPane.showMessageDialog(EditBook.this, "A Book "+txtBookID.getText()+"has been delete");
                  // reload the list book 
                  myBook.showAllBooks();
                  dispose();
